...
| F-19 019 | REUSE lifecycle `WHAT[FINALITY-019] idle encouragement golden bytes`（idle 只鼓励；open/completed 不发送的 fold 侧由 lifecycle 组合断言） | REUSE | lifecycle SPLIT@cutover |
