...
| INTERACTION-AUTHORITY-012 | `requirements/interaction-authority/tests/assistance-host.test.mjs`, `requirements/interaction-authority/tests/assistance-abort-successor-trace.test.mjs`, `requirements/interaction-authority/tests/assistance-capability-boundary.test.mjs` |
| INTERACTION-AUTHORITY-013 | `requirements/interaction-authority/tests/assistance-host.test.mjs`, `requirements/interaction-authority/tests/assistance-capability-boundary.test.mjs` |
