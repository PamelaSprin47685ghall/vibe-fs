...
| INTERACTION-AUTHORITY-018 | `requirements/relay-incumbency/tests/successor-admission.test.mjs::WHAT[INTERACTION-AUTHORITY-018] perfect HumanRoot retirement closes authority with no successor via real fold`；`requirements/relay-incumbency/tests/successor-admission.test.mjs::WHAT[INTERACTION-AUTHORITY-018] AgentOwnerRoot Manager retirement preserves owner-directed authority` |
