...
| INTERACTION-AUTHORITY-006 | `requirements/interaction-authority/tests/authority-root.test.mjs::WHAT[INTERACTION-AUTHORITY-006] IA_006_canonical_names_resolve_and_legacy_or_malformed_are_refused`；`requirements/interaction-authority/tests/authority-root.test.mjs::WHAT[INTERACTION-AUTHORITY-006] IA_006_agent_owner_root_claim_rejects_legacy_name` |
...
| INTERACTION-AUTHORITY-010 | `requirements/interaction-authority/tests/authority-root.test.mjs::WHAT[INTERACTION-AUTHORITY-010] IA_010_terminal_repair_identity_is_exactly_once` |
...
| INTERACTION-AUTHORITY-015 | `requirements/interaction-authority/tests/authority-acceptance-identity.test.mjs::WHAT[INTERACTION-AUTHORITY-015] matching external user ingress continues without replacing the active authority run` |
...
| INTERACTION-AUTHORITY-018 | `requirements/interaction-authority/tests/authority-root.test.mjs::WHAT[INTERACTION-AUTHORITY-018] IA_018_exact_closure_releases_run_scoped_authority_before_root_reuse` |
| INTERACTION-AUTHORITY-019 | `requirements/interaction-authority/tests/join-guard.test.mjs::WHAT[INTERACTION-AUTHORITY-019] gate_nudge_is_exact_terminal_idempotent_and_unbounded_across_fresh_terminals`；`requirements/interaction-authority/tests/repair-lifecycle.test.mjs::WHAT[INTERACTION-AUTHORITY-019] repair claim does not turn an in-flight repair into exhaustion`；`requirements/interaction-authority/tests/repair-lifecycle.test.mjs::WHAT[INTERACTION-AUTHORITY-019] fresh invalid repair terminals re-open the gate reminder`；`requirements/interaction-authority/tests/repair-lifecycle.test.mjs::WHAT[INTERACTION-AUTHORITY-019] a currently-repairing attempt never completes as exhausted or failed repair`；`requirements/interaction-authority/tests/repair-lifecycle.test.mjs::WHAT[INTERACTION-AUTHORITY-019] duplicate gate-nudge claim is AlreadyAdmitted — single physical send` |
| INTERACTION-AUTHORITY-020 | `requirements/interaction-authority/tests/m6-fatal-boundary.test.mjs::WHAT[INTERACTION-AUTHORITY-020] repair fatal preserves exact claim settlement and one injected fuse` |
