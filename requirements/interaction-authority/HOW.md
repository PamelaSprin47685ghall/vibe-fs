...
| INTERACTION-AUTHORITY-003 | `requirements/interaction-authority/tests/authority-root.test.mjs::WHAT[INTERACTION-AUTHORITY-003] IA_003_malformed_profile_role_tier_and_root_kind_fail_closed`；`requirements/interaction-authority/tests/authority-root.test.mjs::WHAT[INTERACTION-AUTHORITY-003] IA_003_root_derives_peer_role_and_tier_from_selected_agent`；`requirements/interaction-authority/tests/authority-root.test.mjs::WHAT[INTERACTION-AUTHORITY-003] IA_003_new_root_clears_run_scoped_state`；`requirements/interaction-authority/tests/authority-root.test.mjs::WHAT[INTERACTION-AUTHORITY-003] IA_003_root_remains_the_source_for_continuations` |
