...
| R12 | INTERACTION-AUTHORITY-014 | `requirements/interaction-authority/tests/join-guard-execution.test.mjs::EXEC_016_join_guard_continuation_kind_is_parseable` + `requirements/interaction-authority/tests/join-guard.test.mjs::JNGD_nudge_sends_join_guard_continuation_and_claims`（claim 持久化半边归 dispatch-protocol） | NEW | `node --test requirements/interaction-authority/tests/join-guard-execution.test.mjs` / `node --test requirements/interaction-authority/tests/join-guard.test.mjs` |
