...
| CRASH-005 | `requirements/crash-reconciliation/tests/child-recovery-workflow.test.mjs::WHAT[CRASH-005] VERIFY_008_child_recovery_workflow_waits_without_committing_when_snapshot_is_unreadable`；`requirements/crash-reconciliation/tests/child-recovery-workflow.test.mjs::WHAT[CRASH-005] VERIFY_008_missing_ports_or_waiting_never_synthesizes_family_ready`；`requirements/crash-reconciliation/tests/child-recovery-workflow.test.mjs::WHAT[CRASH-005] VERIFY_008_executor_tool_empty_or_whitespace_session_id_fails_closed` |
...
| CRASH-011 | `requirements/crash-reconciliation/tests/host-fork-runtime-permit.test.mjs::WHAT[CRASH-011] HFRT_join_with_valid_permit_passes_validation`；`requirements/crash-reconciliation/tests/child-recovery-workflow.test.mjs::WHAT[CRASH-011] VERIFY_008_bare_runtime_join_refusal_and_permit_validation` |
| CRASH-012 | `requirements/crash-reconciliation/tests/child-recovery-workflow.test.mjs::WHAT[CRASH-012] VERIFY_008_child_recovery_workflow_commits_terminal_then_pulses_once_single_owner`；`requirements/crash-reconciliation/tests/child-recovery-workflow.test.mjs::WHAT[CRASH-012] VERIFY_008_child_recovery_workflow_terminal_commit_single_owner_no_raw_publish_completion` |
