  ...
  return [
    // 1. requirements-adapter: 适配层与插件契约、工作树与持久化等日常测试
    {
      ...
      files: [
        ...
        path.join(root, 'requirements/crash-reconciliation/tests/integration/020.test.mjs'),
        path.join(root, 'requirements/office-capability/tests/integration/devops-duplicate-reception.test.mjs'),
        path.join(root, 'requirements/office-capability/tests/integration/devops-process-teardown.test.mjs'),
        path.join(root, 'requirements/office-capability/tests/integration/devops-relay-incumbency.test.mjs'),
        path.join(root, 'requirements/office-capability/tests/integration/fission-historical-recovery.test.mjs'),
      ],
    },
