  ...
  return [
    // 1. requirements-adapter: 适配层与插件契约、工作树与持久化等日常测试
    {
      ...
      files: [
        ...
        path.join(root, 'requirements/office-capability/tests/integration/005.test.mjs'),
        path.join(root, 'requirements/office-capability/tests/integration/007.test.mjs'),
        path.join(root, 'requirements/office-capability/tests/integration/016.test.mjs'),
        path.join(root, 'requirements/office-capability/tests/integration/017.test.mjs'),
      ],
    },
