...
export const [
  ...
  prod('Feedback/Enforcer/Projection'),
  ...
  prod('Change/Orchestration/OrchestratorProjection'),
  ...
  prod('Infrastructure/OpenCode/Tools/Distillation'),
  ...
  prod('Infrastructure/Resources/ProviderResources'),
