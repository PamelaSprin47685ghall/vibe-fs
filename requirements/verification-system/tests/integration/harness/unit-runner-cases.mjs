 ...
 *
 * verification-system-004 says 「运行器必须有测试覆盖这一点」 about the timeout-and-forget rule, and before this
...
export const unitRunnerCases = [
  ...
  {
    name: 'verification-system-004 an overrunning test is failed and forgotten without blaming the next one',
    fn: async () => {
  ...
  {
    name: 'verification-system-004 no fixture is discoverable as a test, and nothing else lives among them',
    fn: () => {
  ...
  {
    name: 'verification-system-004 the runner claims no protection it does not have',
    fn: () => {
