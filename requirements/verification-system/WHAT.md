...
**含义/动机**：可红性是证明资格的地板。canary 迎合错误生产（`changes/completed/canary-
...
**含义/动机**：`changes/completed/fix.md` 教训：DSL 门禁只扫 136/245 个文件仍宣称全量
...
**含义/动机**：`changes/completed/fix.md` 审计的「验收口径事后缩水」：frozen scope 明说
