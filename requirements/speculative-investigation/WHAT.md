...
源条款：`docs/what/strength.md` STRENGTH-001..012（本包主导全部 12 条，COVERAGE.md 单-owner
裁决）；`docs/why/strength.md`、`docs/shape/strength.md`、`docs/how/strength.md`、
`docs/proof/strength.md`、`changes/completed/strength.md`。
