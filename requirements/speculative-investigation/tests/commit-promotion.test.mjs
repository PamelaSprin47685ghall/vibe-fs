...
test('STRENGTH_006_prepared_commit_unknown_is_resolved_without_guessing', () => {
...
test('STRENGTH_007_promotion_commit_unknown_never_allows_continuation_without_durable_fact', () => {
...
test('STRENGTH_007_promotion_requires_the_exact_target_run_and_real_provider_output', () => {
