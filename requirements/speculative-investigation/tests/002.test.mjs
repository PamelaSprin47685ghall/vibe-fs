...
test('WHAT[speculative-investigation-002] STRENGTH_002_010_policy_rejects_unknown_role_and_request_kind', () => {
...
test('WHAT[speculative-investigation-002] STRENGTH_002_010_policy_is_fail_closed_and_only_treats_proven_fixed_identity_opportunities', () => {
...
test('WHAT[speculative-investigation-002] STRENGTH_002_speculation_opportunity_eligibility_is_pure_frozen_evidence_without_wall_clock_state', () => {
...
test('WHAT[speculative-investigation-002] STRENGTH_002_013_review_finality_and_attached_internal_leaf_are_always_k0', () => {
...
test('WHAT[speculative-investigation-002] STRENGTH_002_003_target_unbound_and_replica_request_kind_are_k0', () => {
...
test('WHAT[speculative-investigation-002] StrengthSpeculate owns tryApply entry point for transform speculation', () => {
...
test('WHAT[speculative-investigation-002] STRENGTH_002_replica_transform_mode_is_explicit_semantic_alternative_in_composition_root', () => {
  const pt = read('src/Wanxiangshu/OpenCode/Plugin/PluginTransforms.fs')
