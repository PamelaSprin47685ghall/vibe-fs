...
const fissionSurface = await import("../../../dist/Execution/Fission/Surface.js");
const { integrationTest } = await import("../../verification-system/tests/support/tier-gate.mjs");

integrationTest('WHAT[office-capability-016] Engineer exclusively holds Fission authority and historical Manager Fission state never resurrects active lanes', async () => {
