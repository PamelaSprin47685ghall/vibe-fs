...
import { commitPlan as fsCommitPlan } from '../../../dist/Repository/Programming/Js/FilesystemSurface.js'
import { generate } from '../../../dist/Repository/Programming/Js/GeneratorSurface.js'
import { preflight, commitPlan as txCommitPlan } from '../../../dist/Repository/Programming/Js/TransactionSurface.js'
import { run, caseName, rewritten, created } from '../../../dist/Repository/Programming/Js/WorkflowSurface.js'

const commitPlan = (dirOrMutations, maybePlan) => {
  if (maybePlan !== undefined) {
    return fsCommitPlan(dirOrMutations, maybePlan)
  }
  return txCommitPlan(dirOrMutations)
}
