...
//
// PROMPT-006: send-time options at every dispatch:
//
...
// (DISPATCH-PROTOCOL-001/011 R6；agent 绑定半边概念上属 participant-identity，
// 但 participant-identity 无 REUSE 落点，本文件整体归 dispatch-protocol。)
