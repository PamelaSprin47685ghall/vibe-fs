...
| CAUSAL-009 | `requirements/causal-wait/tests/m6-slice-boundary.test.mjs::WHAT[CAUSAL-009] causal wait contract excludes registry diagnostics mailbox and proof runtime` |
