...
| EXECFAIL-002 | `requirements/execution-failure-policy/tests/policy.test.mjs::WHAT[EXECFAIL-002] every phase and failure yields exactly one resolution and orthogonal dimensions`；`requirements/execution-failure-policy/tests/cancel-retry-stream.test.mjs::WHAT[EXECFAIL-002] cancel/retry/stream matrix is interpreted by registered owners` |
| EXECFAIL-003 | `requirements/execution-failure-policy/tests/policy.test.mjs::WHAT[EXECFAIL-003] rejects illegal retry and breaker policy mutations`；`requirements/execution-failure-policy/tests/cancel-retry-stream.property.test.mjs::WHAT[EXECFAIL-003] finite provider budget matrix fixes policy and recovery outcomes` |
...
| EXECFAIL-010 | `requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] scanner finds direct FatalProcess and Diagnostic call sites`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] scanner ignores comments, strings, and point-free bindings`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] scanner resolves a point-free alias one hop to its use`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] scanner resolves a ReportFatalDiagnostic forwarder one hop`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] gate fails on a fatal call site with no inventory row`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] gate fails on an alias invocation with no inventory row`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] gate fails when the row operation left its source file`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] gate fails when FixedWithRegression names a missing test`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] gate passes FixedWithRegression when the named test exists`；`requirements/execution-failure-policy/tests/fatal-inventory-gate.test.mjs::WHAT[EXECFAIL-010] gate passes when every site has a row and no row is stale` |
| EXECFAIL-009 | `requirements/execution-failure-policy/tests/host-codec.test.mjs::WHAT[EXECFAIL-001] Host adapter returns closed typed failures from structural evidence`；`requirements/execution-failure-policy/tests/cancel-retry-stream.test.mjs::WHAT[EXECFAIL-002] cancel/retry/stream matrix is interpreted by registered owners`；`requirements/managed-chat-execution/tests/provider-terminal-accounting.test.mjs::WHAT[CHATEXEC-006] exact cancel and interruption become closed typed terminal dispositions` |
