...
test('WHAT[SESSION-ONTOLOGY-010] COMPANION_001_an_unknown_session_is_not_a_Companion', () => {
...
test('WHAT[SESSION-ONTOLOGY-008] HOST_008_linking_records_both_directions_at_once', () => {
...
test('WHAT[SESSION-ONTOLOGY-008] COMPANION_002_the_Companion_side_answers_isCompanion_immediately', () => {
...
test('WHAT[SESSION-ONTOLOGY-008] COMPANION_002_a_Companion_is_structurally_a_leaf', () => {
...
test('WHAT[SESSION-ONTOLOGY-008] COMPANION_002_giving_a_Companion_its_own_Companion_is_refused', () => {
  const state = linked([{ main: 'ses_x', blogger: 'ses_y' }])
...
test('WHAT[SESSION-ONTOLOGY-009] COMPANION_001_every_work_session_may_have_a_Y_regardless_of_role', () => {
...
test('WHAT[SESSION-ONTOLOGY-008] COMPANION_003_relinking_the_same_pair_is_idempotent', () => {
...
test('WHAT[SESSION-ONTOLOGY-008] COMPANION_002_a_second_different_Y_for_one_work_session_is_refused', () => {
...
test('WHAT[SESSION-ONTOLOGY-005] HOST_008_one_Companion_cannot_serve_two_work_sessions', () => {
...
test('WHAT[SESSION-ONTOLOGY-008] HOST_008_one_Companion_cannot_serve_two_work_sessions', () => {
  const state = linked([{ main: 'ses_x1', blogger: 'ses_y' }])
...
test('WHAT[SESSION-ONTOLOGY-005] HOST_008_a_session_cannot_be_its_own_Companion', () => {
...
test('WHAT[SESSION-ONTOLOGY-008] HOST_008_a_session_cannot_be_its_own_Companion', () => {
  const self = assoc.link({ main: 'ses_x', blogger: 'ses_x' }, assoc.empty)
...
test('WHAT[SESSION-ONTOLOGY-006] HOST_008_the_work_session_parent_is_recorded_when_supplied', () => {
...
test('WHAT[SESSION-ONTOLOGY-006] HOST_008_relinking_without_a_parent_does_not_erase_a_known_one', () => {
...
test('WHAT[SESSION-ONTOLOGY-009] COMPANION_003_unlinking_frees_the_work_session_to_get_a_fresh_Y', () => {
  const state = linked([{ main: 'ses_x', blogger: 'ses_y1' }])
