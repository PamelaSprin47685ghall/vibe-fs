...
- **Physical evidence 合法性**：`PhysicalUserMessageId.isNonBlank` 是 JudgeTool、Direct CE、witness construction 与 replay qualification 的唯一空白判定；非法 evidence 在追加 verdict fact 前拒绝。
