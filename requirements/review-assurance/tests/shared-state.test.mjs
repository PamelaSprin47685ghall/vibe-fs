...
// owner: review-assurance. REVIEW-010 PendingSeal shape —— parked seal candidate
// 携带 binding candidate（SessionId / PhysicalUserMessageId / SealDigest /
// CanonicalVersion / IncludedToolResultDigests）并经共享 map round-trip。
// HOST-012 共享面单例断言归 host-boundary（HOST-BOUNDARY-010）。
