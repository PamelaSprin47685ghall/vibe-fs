...
test('WHAT[behavior-diagnosis-002] ENFORCER_resource_catalog_json_is_not_runtime_ssot', () => {
  assert.equal(fs.existsSync(path.join(enforcerRoot, 'catalog.json')), false)
})

test('WHAT[behavior-diagnosis-002] ENFORCER_resource_rulebook_load_is_independent_of_process_cwd', () => {
