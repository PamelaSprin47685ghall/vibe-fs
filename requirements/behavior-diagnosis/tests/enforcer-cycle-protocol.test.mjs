// Split from tests/unit/enforcer/enforcer-cycle-protocol.test.mjs (cutover Wave 2a); owner: behavior-diagnosis.
//
// ENFORCER-060/061/064..068 — InteractionNudge → AABB + empty-text / no-blog.
// BD-017: bounded protocol repair for invalid cycles (nudge once / idempotent /
// abort does not advance). The convergence-chain half (flight gate, commit,
// park, drain, live-vs-open resolution) moved to context-compression
// (enforcer-cycle-convergence.test.mjs).
//
