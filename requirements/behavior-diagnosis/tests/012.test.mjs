// BD-012: BlogObservationCommitted is the single atomic cycle fact
...
const observationRecord = (overrides = {}) => ({
  case: 'BlogObservationCommitted',
  sessionId: 'ses_obs',
...
test('WHAT[BD-012] PERSIST_005_observation_encode_writes_new_tags_only', () => {
  const committed = blog.serializeFact(observationRecord())
...
test('WHAT[BD-012] OBS_PROJ_002_zip_recent_tips_with_blog_frame_digests', () => {
  ...
  assert.deepEqual(readObs(enforcement, blogState), [
