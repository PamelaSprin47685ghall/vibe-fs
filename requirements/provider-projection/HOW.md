...
| PROVIDER-PROJECTION-003 | `requirements/provider-projection/tests/projection.test.mjs::WHAT[PROVIDER-PROJECTION-003] retry continuation origin stays in Host metadata, outside provider semantics`；`requirements/provider-projection/tests/misc-codecs-host-wire.test.mjs::WHAT[PROVIDER-PROJECTION-003] MISC_ingress_session_id_sources` |
| PROVIDER-PROJECTION-003 | `requirements/provider-projection/tests/misc-codecs-host-wire.test.mjs::WHAT[PROVIDER-PROJECTION-003] MISC_ingress_host_synthetic_requires_fully_injected_material` |
