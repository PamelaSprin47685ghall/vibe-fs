...
（`isAppendOnlyPrefix`）；`changes/completed/cache.md` §1/§2/§11。
...
**证据**：COMPANION-009；`shape/companion.md`（epoch 切换表）；`docs/why/context.md`。
...
**证据**：HOST-013 行为约束 5/7；cache.md §10；`docs/why/host.md` 决策 13。
