...
### 4.1 `cache.md`（HOST-013 anchored prefix，changes/completed/cache.md）
...
### 4.3 `docs/why/host.md` 决策 9–13（HOST-013）
...
- `docs/what/host.md`（HOST-005/006/013）、`docs/why/host.md`（决策 9–13）
- `docs/what/companion.md`（COMPANION-009/010/011/013）、`docs/shape/companion.md`
- `docs/what/context.md`（CTX-010/011/012/015）、`docs/why/context.md`（ActivePrefixEpoch 理由）
- `docs/what/prompt.md`（PROMPT-014）、`docs/what/todo.md`（TODO-009）、`docs/what/architecture.md`（ARCH-004）
- `changes/completed/cache.md`、`changes/completed/cursor-pair-hint.md`（§12）、`changes/completed/pair-parallel-tools.md`（prefix 相关）
