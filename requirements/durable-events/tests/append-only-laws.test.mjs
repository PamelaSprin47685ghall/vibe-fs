...
test('append_only_prior_writer_bytes_are_a_strict_prefix_after_new_fact', async () => {
...
test('one_writer_is_one_file_regardless_of_history_size', async () => {
...
test('duplicate_same_identity_is_idempotent_but_collision_is_rejected', async () => {
