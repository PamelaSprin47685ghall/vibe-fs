...
| EXTERNAL-INVESTIGATION-002（provenance-not-reachability） | 同上 `WHAT[EXTERNAL-INVESTIGATION-002] browser_provenance_anchor_ids_are_pinned_to_the_eight_distinctions`（id pin）+ `WHAT[EXTERNAL-INVESTIGATION-002] provenance-not-reachability anchor hits real Role Law in both locales`（锚点双语命中） | NEW | 同上 |
| EXTERNAL-INVESTIGATION-003（far-shore） | 同上 `WHAT[EXTERNAL-INVESTIGATION-003] far-shore anchor hits real Role Law in both locales`（锚点双语命中 + id pin） | NEW | 同上 |
| EXTERNAL-INVESTIGATION-004（source-closest） | 同上 `WHAT[EXTERNAL-INVESTIGATION-004] source-closest anchor hits real Role Law in both locales`（锚点双语命中 + id pin） | NEW | 同上 |
| EXTERNAL-INVESTIGATION-005（visual-truth） | 同上 `WHAT[EXTERNAL-INVESTIGATION-005] visual-truth anchor hits real Role Law in both locales`（锚点双语命中 + id pin） | NEW | 同上 |
| EXTERNAL-INVESTIGATION-006（condition-preserved） | 同上 `WHAT[EXTERNAL-INVESTIGATION-006] condition-preserved anchor hits real Role Law in both locales`（锚点双语命中 + id pin） | NEW | 同上 |
| EXTERNAL-INVESTIGATION-007（inference-not-observation） | 同上 `WHAT[EXTERNAL-INVESTIGATION-007] inference-not-observation anchor hits real Role Law in both locales` + `WHAT[EXTERNAL-INVESTIGATION-007] removing_one_distinction_from_the_fixture_turns_red`（删掉该区分 → 红，证明锚点有区分力） | NEW | 同上 |
