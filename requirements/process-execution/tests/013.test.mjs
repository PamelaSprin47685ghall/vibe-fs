...
test('WHAT[process-execution-013] large_command_output_produces_raw_tail_with_zero_distiller_sessions', async () => {
  ...
  // process-execution-013: 零 Distiller 模型会话，输出直接保留未修改的原始尾部，不出现模型摘要字样
...
test('WHAT[process-execution-013] small_command_output_within_budget_is_returned_raw_unmodified', async () => {
