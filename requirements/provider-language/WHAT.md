...
**证据**：历史 HOST 条款 HOST-026、历史 PROMPT 条款 PROMPT-017/014。
...
**证据**：历史 HOST 条款 HOST-026、历史 proof/host 条款「SessionProviderLanguage
证明」child 继承行。
...
**证据**：历史 HOST 条款 HOST-026、历史 why/host 条款 §21。
...
**证据**：历史 PROMPT 条款 PROMPT-017（Localizable/Invariant 表）、PROMPT-019。
...
**证据**：历史 PROMPT 条款 PROMPT-019、历史 ARCH 条款 ARCH-016 Gate C。
...
**证据**：历史 PROMPT 条款 PROMPT-019、PromptRestoration Gate C。
...
`action-affordance`。
**证据**：历史 PROMPT 条款 PROMPT-019、历史 how/prompt 条款「Tool description 按
已绑语言装载」。
...
「谁的语言、何时装载」这条轴。
**证据**：历史 PROMPT 条款 PROMPT-019、历史 how/prompt 条款「Provider-visible
...
**证据**：历史 proof/prompt 条款「EN / zh-CN 语言面」Role Law semantic-anchor 行。
...
**证据**：历史 PROMPT 条款 PROMPT-017 invariant 列、PROMPT-019 Class B。
