...
| 源 → 目标 | 适配 | 验证 |
|---|---|---|
| `requirements/provider-language/tests/provider-language.test.mjs` → `requirements/provider-language/tests/provider-language.test.mjs` | `../support/domain.mjs` → `../../../tests/unit/support/domain.mjs` | `node --test` 4/4 绿 |
