...
| SEMANTIC-TRACE-005 | `requirements/semantic-trace/tests/x-trace.test.mjs::WHAT[SEMANTIC-TRACE-005] canonical render is deterministic and omits provenance` |
