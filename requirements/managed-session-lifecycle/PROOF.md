...
| MANAGED-SESSION-011 | `tests/satellite-runtime.test.mjs` `HOST_015_companion_satellite_recovery_creates_an_explicit_replacement_when_the_old_child_is_gone` / `HOST_015_companion_satellite_recovery_fails_closed_when_journal_linked_child_conflicts` / `HOST_015_companion_satellite_recovery_replaces_without_adopting_same_agent_sibling` / `HOST_014_children_query_failure_does_not_guess_or_create` | MOVE | `node --test requirements/managed-session-lifecycle/tests/satellite-runtime.test.mjs` |
