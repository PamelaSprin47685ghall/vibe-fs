...
| MANAGED-SESSION-007 | `requirements/managed-session-lifecycle/tests/handle.test.mjs::WHAT[MANAGED-SESSION-007] EXEC_004_the_first_completion_wins_and_later_ones_are_refused`；`requirements/managed-session-lifecycle/tests/handle.test.mjs::WHAT[MANAGED-SESSION-007] EXEC_004_each_completion_kind_survives_into_the_state`；`requirements/managed-session-lifecycle/tests/join-completion-property.test.mjs::WHAT[MANAGED-SESSION-007] every completion race preserves the first production winner` |
...
| MANAGED-SESSION-016 | `requirements/managed-session-lifecycle/tests/interrupt-boundary.test.mjs::WHAT[MANAGED-SESSION-016] Sessions adapter rejects root attempt interrupt and physically aborts a managed child exactly once`；`requirements/managed-session-lifecycle/tests/interrupt-boundary.test.mjs::WHAT[MANAGED-SESSION-016] managed interrupt Host rejection is terminal after exactly one AbortSession attempt`；`requirements/managed-session-lifecycle/tests/interrupt-boundary.test.mjs::WHAT[MANAGED-SESSION-016] Turn orchestration consumes typed outcome without cross-callback aborted registry PC` |
| MANAGED-SESSION-017 | `requirements/managed-session-lifecycle/tests/interrupt-successor.test.mjs::WHAT[MANAGED-SESSION-017] fail-closed interrupt becomes Failed terminal so fork completion wakes parent`；`requirements/managed-session-lifecycle/tests/interrupt-successor.test.mjs::WHAT[MANAGED-SESSION-017] invariant and tool fail-closed paths cannot use orphan InterruptAttempt`；`requirements/managed-session-lifecycle/tests/interrupt-successor.test.mjs::WHAT[MANAGED-SESSION-017] raw InterruptAttempt callers are restricted to workflows with an explicit successor owner`；`requirements/managed-session-lifecycle/tests/interrupt-successor.test.mjs::WHAT[MANAGED-SESSION-017] fatal termination never stores cross-callback cause state` |
...
| MANAGED-SESSION-020 | `requirements/managed-session-lifecycle/tests/reused-session-run-closure.test.mjs::WHAT[MANAGED-SESSION-020] fresh identity waits for exact durable prior-run closure on the public plugin canary`；`requirements/managed-session-lifecycle/tests/subagent-reuse-closure.property.test.mjs::WHAT[MANAGED-SESSION-020] subagent session reuse property verifies prior-run closure across arbitrary agent sequences`；`requirements/managed-session-lifecycle/tests/subagent-reuse-closure.property.test.mjs::WHAT[MANAGED-SESSION-020] subagent authority closure cleans claims, continuations, and sequences while retaining history`；`requirements/managed-session-lifecycle/tests/subagent-reuse-closure.property.test.mjs::WHAT[MANAGED-SESSION-020] Manager AgentOwnerRoot remains active for owner-directed post-life recovery`；`requirements/managed-session-lifecycle/tests/subagent-reuse-closure.property.test.mjs::WHAT[MANAGED-SESSION-020] mutant: omitting child-work closure causes fast-check to detect ActiveRunIdentityConflict` |
| MANAGED-SESSION-021 | `requirements/managed-session-lifecycle/tests/m6-fatal-boundary.test.mjs::WHAT[MANAGED-SESSION-021] lifecycle fatal follows exact drain and one injected fuse` |
| MANAGED-SESSION-022 | `requirements/managed-session-lifecycle/tests/inspector-finalize-settlement.test.mjs::WHAT[MANAGED-SESSION-021] INSPECTOR_SETTLE_finalized_releases_identity_exactly_once`；`requirements/managed-session-lifecycle/tests/inspector-finalize-settlement.test.mjs::WHAT[MANAGED-SESSION-021] INSPECTOR_SETTLE_nothing_to_finalize_is_not_a_failure`；`requirements/managed-session-lifecycle/tests/inspector-finalize-settlement.test.mjs::WHAT[MANAGED-SESSION-022] INSPECTOR_SETTLE_uncommitted_finalize_does_not_publish_a_case`；`requirements/managed-session-lifecycle/tests/inspector-finalize-settlement.test.mjs::WHAT[MANAGED-SESSION-021] INSPECTOR_SETTLE_identity_retention_is_owner_driven_not_finally` |

`HOST-BOUNDARY-013` 的真实 plugin bootstrap 回归补充证明自动 sensor 只中断 managed physical child；已删除原先仅匹配 `LoopSensor.create`、lambda 与 predicate 源码的断言。该断言曾在动态接线完全不安装 sensor 时仍通过，不能承担 MANAGED-SESSION-016 的行为证明。
