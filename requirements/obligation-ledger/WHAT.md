...
## [001] 当前义务是当前仍欠的工作而非 workflow status
...
## [002] obligations wire 与 CurrentObligations 定义
...
## [004] planning work 只在 commitment 前合法
...
## [007] 同 message 多已 materialize todowrite 顺序执行与单 inflight
...
## [010] Accepted 立即 supersede CurrentObligations
...
## [012] checkpoint 的 SSOT 为 TodoWriteAccepted
...
## [015] canonical 单真相源 vs Host compatibility sink
...
## [016] T1 commitment 与 Opening 关闭
...
## [017] Manager BlindPlan Opening（无生产 Activation）
...
## [020] 质量判断归于独立 assessment，不设终局评审

实现质量由独立 assessment 按公开准则与事实证据判断，不得自证（relay-assessment relay-assessment-006）。本账本只记录义务的认领与结转，不做质量裁决。

## [021] desired lag-1 cutoff 仅由 committed Accepted 子链推导
...
## [025] before 合同（materialization 与 Prepared 冻结）
...
## [028] ledger fatal绑定checkpoint settlement与注入fuse
