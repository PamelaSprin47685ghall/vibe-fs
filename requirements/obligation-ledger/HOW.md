...
| OBLIGATION-LEDGER-007 | `requirements/obligation-ledger/tests/magic-todo.test.mjs::WHAT[OBLIGATION-LEDGER-007] admits multiple todowrite calls in one assistant message with sequential execution semantics` |
...
| OBLIGATION-LEDGER-026 | `requirements/obligation-ledger/tests/magic-todo-after.test.mjs::WHAT[OBLIGATION-LEDGER-026] after hook accepts checkpoint durably and enriches T1 revelation`；`requirements/obligation-ledger/tests/magic-todo-membrane.test.mjs::WHAT[OBLIGATION-LEDGER-026] host before/after hook rejects without active incumbency as typed tool rejection, not infrastructure fatal` |
...
| OBLIGATION-LEDGER-028 | `requirements/obligation-ledger/tests/m6-fatal-boundary.test.mjs::WHAT[OBLIGATION-LEDGER-028] ledger fatal follows exact checkpoint settlement and one injected fuse` |
