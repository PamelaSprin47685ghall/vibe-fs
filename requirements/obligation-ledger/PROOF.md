...
| O-16 016 | `tests/opening-floor.test.mjs` `AC15/AC16 Post-T1: WorkRecordStart nails after T1 call+result`、`AC16: T1 constitutive body renders in Opening, not Recent`、`AC16: XTrace.forOpening keeps T1 tools...`；REUSE `requirements/finality/tests/lifecycle.test.mjs` `GLORY_074_t1_revelation_hook`；`tests/magic-todo-provider-boundary.test.mjs` `TODO-002/TODO-015 first todowrite is a finished mission account...` | MOVE + REUSE | `node --test requirements/obligation-ledger/tests/opening-floor.test.mjs` |
