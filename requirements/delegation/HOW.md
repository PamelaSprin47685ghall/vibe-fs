...
| DELEG-031 | `requirements/delegation/tests/completion-settlement.test.mjs::WHAT[DELEG-031] DELEG_031_committed_checkpoint_advances_frontier_and_delivers_work_record`；`requirements/delegation/tests/completion-settlement.test.mjs::WHAT[DELEG-031] DELEG_031_uncommitted_checkpoint_still_delivers_work_record_without_reexecution`；`requirements/delegation/tests/completion-settlement.test.mjs::WHAT[DELEG-031] DELEG_031_duplicate_completion_is_idempotent_and_never_reexecutes`；`requirements/delegation/tests/completion-settlement.test.mjs::WHAT[DELEG-031] DELEG_031_stale_authority_completion_cannot_claim_a_new_call`；`requirements/delegation/tests/completion-settlement.test.mjs::WHAT[DELEG-031] DELEG_031_parent_supersede_leaves_no_orphan_completion_claim`；`requirements/delegation/tests/completion-settlement.test.mjs::WHAT[DELEG-031] DELEG_031_completed_and_delete_in_both_orders_settle_exactly_once` |
