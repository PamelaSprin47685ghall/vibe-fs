...
test('WHAT[delegation-016] JOIN_V2_empty_batch_is_plain_empty_wire', () => {
  assert.equal(join.renderBatch('english', []), '')
})

test('WHAT[delegation-016] JOIN_V2_malformed_role_run_or_kind_is_rejected_without_success_wire', () => {
