...
| DELEG-008 batch 由 Host tool-call 集合决定 | `requirements/delegation/tests/sync-delegate-runtime.test.mjs::SYNC_RUNTIME_provider_tool_call_collection_preserves_role_order` | NEW | `node --test requirements/delegation/tests/sync-delegate-runtime.test.mjs` |
