...
| DELEG-008 batch 由 Host tool-call 集合决定 | `requirements/delegation/tests/sync-delegate-runtime.test.mjs` `EXEC_026_sync_delegate_provider_batch_coalesces_without_race_and_returns_once` | REUSE | `node --test requirements/delegation/tests/sync-delegate-runtime.test.mjs` |
