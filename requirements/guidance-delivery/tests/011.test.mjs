...
test('WHAT[guidance-delivery-011] GP_001_empty_state_starts_ordinal_at_one', () => {
  assert.equal(nextOrdinal(empty), 1n)
  assert.deepEqual(pairs(empty), [])
})
test('WHAT[guidance-delivery-011] GP_002_apply_records_pair_and_restores_marker_bytes', () => {
...
test('WHAT[guidance-delivery-011] GP_003_non_sequential_ordinal_is_rejected', () => {
...
test('WHAT[guidance-delivery-011] GP_004_duplicate_call_id_is_rejected', () => {
...
test('WHAT[guidance-delivery-011] GP_005_duplicate_placement_is_rejected', () => {
...
test('WHAT[guidance-delivery-011] GP_006_replay_restores_pairs_oldest_first', () => {
  let state = empty
  for (let n = 1n; n <= 3n; n++) {
...
test('WHAT[guidance-delivery-011] GP_007_reanchor_retires_visible_pairs_without_deleting_durable_history', () => {
...
test('WHAT[guidance-delivery-011] PPT_gap_constructor_receives_the_same_address_exactly_twice_in_pair_order', () => {
...
test('WHAT[guidance-delivery-011] PPT_gap_constructor_failure_propagates_from_the_first_call_and_stops_the_pair', () => {
