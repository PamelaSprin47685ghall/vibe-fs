...
## [002] JS semantic tests 只能调用正式 semantic surface
...
## [003] 值得独立测试的 law 必须有独立 semantic owner + JS surface
...
## [005] semantic data 跨边界必须是 JS-native representation
...
## [006] Fable runtime representation 不属于 semantic contract
