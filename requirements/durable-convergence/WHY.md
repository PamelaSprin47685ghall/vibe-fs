...
| 方案 | 为什么拒 |
|---|---|
| revision + wall_clock LWW 裁决同 Case 冲突 | Store 保存 immutable facts 不是 mutable snapshot；timestamp 不证明内容未变；LWW = 丢分支（历史 change（storage）） |ge.md §19、§10.10；archive/docs/why/casebook.md） |
