module Wanxiangshu.Runtime.MessageTransform.ContextBudgetEngineHelper
...
let resolveTokensAndCalibration
...
let writeLastTrace (plan: MessageTransformPlan) (trace: DecisionTrace) : unit =
