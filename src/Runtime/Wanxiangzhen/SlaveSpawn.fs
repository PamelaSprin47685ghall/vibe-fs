module Wanxiangshu.Runtime.Wanxiangzhen.SlaveSpawn
...
let buildSlaveCommand (terminal: string) (worktree: string) (prompt: string) : string * string array =
    ...
    | "konsole" -> "konsole", Array.append [| "--workdir"; worktree; "-e"; "opencode" |] ocArgs
    ...
    | "iterm2" ->
        ...
        [| "-e"
           ...
           "-e"
           sprintf "tell application \"iTerm\" to tell current session of current window to write text \"%s\"" script |]
    | "headless" -> "opencode", ocArgs
    | _ -> terminal, Array.append [| "--working-directory"; worktree; "-e"; "opencode" |] ocArgs
