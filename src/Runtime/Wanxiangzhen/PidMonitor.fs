module Wanxiangshu.Runtime.Wanxiangzhen.PidMonitor
...
let startPolling (intervalMs: int) (check: unit -> unit) : obj = setInterval_ check intervalMs

let stopPolling (handle: obj) : unit = clearInterval_ handle
