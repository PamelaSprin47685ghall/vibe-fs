...
let private spawnCtx (host: Host) (registry: ChildAgentRegistry) (ctx: obj) (client: obj) (context: obj) (runtime: obj) =
    { Host = host; Registry = registry; Client = client; PluginCtx = ctx; ToolContext = context; FallbackRuntime = unbox runtime }

let private executeSubagent (host: Host) (registry: ChildAgentRegistry) (ctx: obj) (toolName: string) (args: obj) (context: obj) (runtime: obj) =
...
let coderTool (host: Host) (registry: ChildAgentRegistry) (ctx: obj) (runtime: obj) : obj =
...
let investigatorTool (host: Host) (registry: ChildAgentRegistry) (ctx: obj) (runtime: obj) : obj =
...
let meditatorTool (host: Host) (registry: ChildAgentRegistry) (ctx: obj) (runtime: obj) : obj =
...
let browserTool (host: Host) (registry: ChildAgentRegistry) (ctx: obj) (runtime: obj) : obj =
