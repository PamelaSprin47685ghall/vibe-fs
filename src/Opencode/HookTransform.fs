...
let messagesTransform (registry: ChildAgentRegistry) (directory: string) (magicSession: VibeFs.Opencode.MagicTodo.MagicSession) (wikiRuntime: VibeFs.Opencode.WikiRuntime.WikiRuntime) (reviewStore: VibeFs.Shell.ReviewRuntime.ReviewStore) (editPlusState: VibeFs.Opencode.EditPlusState.EditPlusState option) (input: obj) (output: obj) : JS.Promise<unit> =
    MessageTransform.messagesTransform registry directory magicSession wikiRuntime reviewStore editPlusState input output
