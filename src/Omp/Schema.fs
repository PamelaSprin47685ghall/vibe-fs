...
let str (description: string) (typebox: obj) = typebox?Type?String(createObj [ "description", box description ])

let num (description: string) (typebox: obj) = typebox?Type?Number(createObj [ "description", box description ])

let bool_ (description: string) (typebox: obj) = typebox?Type?Boolean(createObj [ "description", box description ])
