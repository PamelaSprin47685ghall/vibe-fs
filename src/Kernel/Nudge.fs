...
let internal isQuestion (text: string) = cleanTextOutsideCodeFences text |> questionRe.IsMatch
let internal skipsTodo (text: string) = cleanTextOutsideCodeFences text |> skipTodoRe.IsMatch
let internal skipsLoop (text: string) = cleanTextOutsideCodeFences text |> skipLoopRe.IsMatch
