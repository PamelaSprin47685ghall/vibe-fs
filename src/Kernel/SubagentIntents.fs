...
let coderTargetDraftDesc =
    "Optional minimal draft for the coder to reference. Prefer leaving this empty; use only when strict quality needs a concrete sketch. No patch or special format required."
...
let coderBackgroundDesc =
    "Why this change is needed; prior findings and user context."
