        ...
        createObj
            [ "name", box "swap"
              ...
              box (fun (_id: string) (params': obj) (_s: obj) (_u: obj) (ctx: obj) ->
                  promise {
                      let cwd = Wanxiangshu.Runtime.Dyn.str ctx "cwd"
                      ...
                      let path0 = resolvePath (Wanxiangshu.Runtime.Dyn.str params' "path0")
                      let begin0 = unbox<int> (Wanxiangshu.Runtime.Dyn.get params' "begin0")
                      let endExclusive0 = unbox<int> (Wanxiangshu.Runtime.Dyn.get params' "endExclusive0")
                      let path1 = resolvePath (Wanxiangshu.Runtime.Dyn.str params' "path1")
                      let begin1 = unbox<int> (Wanxiangshu.Runtime.Dyn.get params' "begin1")
                      let endExclusive1 = unbox<int> (Wanxiangshu.Runtime.Dyn.get params' "endExclusive1")
