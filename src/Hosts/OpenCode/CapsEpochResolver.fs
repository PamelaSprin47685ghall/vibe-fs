module Wanxiangshu.Hosts.Opencode.CapsEpochResolver
...
let resolveCapsEpoch (messagesList: Message<obj> list) (sessionID: string) (runtimeScope: RuntimeScope) : string =
