module Wanxiangshu.Hosts.Opencode.PluginWanxiangzhen
...
let private coordinatorPlugin (ctx: obj) : JS.Promise<obj> =
    promise {
        let directory = Wanxiangshu.Runtime.Dyn.str ctx "directory"
        ...
        Wanxiangshu.Hosts.Opencode.PluginWanxiangzhenE2eMeta.writeE2eMetaIfEnabled result.runtime
        return result.hooks
    }
...
let pluginWithDeps (ctx: obj) (deps: Wanxiangshu.Runtime.Wanxiangzhen.CoordinatorRuntime.CoordinatorDeps) =
