    ...
    let handleContinuation
        ...
        task {
            ...
            | _ ->
                ...
                // (ENFORCER-051 origin, no assistant step yet), a restarted
                // session's next prompt (historical assistant messages exist
                // but carry no completed blog call), or a text-out step. None
                // of these park — the provider request must go out.
                return rawMessages
        }
