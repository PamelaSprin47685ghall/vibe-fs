...
module JsTransaction =
    ...
    val validateTargets: exists: (string -> bool) -> mutations: JsStagedMutation list -> Result<unit, JsFailure>
...
module JsTransactionProjection =
    ...
    val prepared:
        eventId: EventId ->
        value: JsTransactionPrepared ->
        projection: JsTransactionProjection ->
            JsTransactionProjection

    val committed:
        eventId: EventId ->
        value: JsTransactionCommitted ->
        projection: JsTransactionProjection ->
            JsTransactionProjection
