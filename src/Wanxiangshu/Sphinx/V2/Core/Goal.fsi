...
module Goal =
    ...
    val amend: authorizedBy: string -> addedConstraints: string list -> replacementText: string option -> GoalSpec -> GoalSpec
    val tryAmend:
        authorizedBy: string -> addedConstraints: string list -> replacementText: string option -> GoalSpec ->
