        ...
        { new IPromptJournal with
            ...
            member _.Append sessionId providerRun fact =
                task {
                    let agentFact =
                        match fact with
                        | PromptSessionFact.AuthorityRootAccepted payload ->
                            PromptFact.AuthorityRootAccepted payload
                        | PromptSessionFact.PromptClaimed payload ->
                            PromptFact.PluginPromptClaimed payload
                        | PromptSessionFact.PromptSubmitted payload ->
                            PromptFact.PluginPromptSubmitted payload
                        | PromptSessionFact.PromptPhysicalAccepted payload ->
                            PromptFact.PluginPromptPhysicalAccepted payload
                        | PromptSessionFact.PromptAbandoned payload ->
                            PromptFact.PluginPromptAbandoned payload
            ...
            member _.ChatAcceptancePersistence() : Wanxiangshu.Execution.Session.ChatExecution.ManagedChatAcceptancePersistence =
                { ReadExact =
                    fun key ->
