...
let decodeMessage sessionID msg =
    Wanxiangshu.Shell.MessagingDecodeCore.decodeMessage muxAdapters sessionID msg

let decodeMessages sessionID msgs =
    Wanxiangshu.Shell.MessagingDecodeCore.decodeMessages muxAdapters sessionID msgs
