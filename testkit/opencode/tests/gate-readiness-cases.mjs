...
import { ReadinessLadder, READINESS_STAGES } from '../readiness.js';
import { CANARY_READY_MS, READINESS_STAGE_MS } from '../time-budget.js';

const REPO_ROOT = fileURLToPath(new URL('../../../', import.meta.url));

/** The two files that print the stage lines. Nothing else may own a stage marker. */
const STAGE_SOURCES = ['testkit/opencode/scenario-parallel.js', 'testkit/opencode/process-host.js'];
