 ...
 *
 * Production is reached through `testkit/opencode/production.js` rather than by importing the emitted
...
import { auditPayload, roundTripValue, splitDocument } from '../arch010.js';
import {
  bloggerDocument,
  bloggerDocumentWith,
  bloggerItem,
