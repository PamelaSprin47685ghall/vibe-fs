 ...
 *
 * Fixtures live in `tests-mjs/fixtures/*.fixture.mjs`. The suffix is not cosmetic: `runner.mjs`
...
const RUNNER = 'tests-mjs/runner.mjs';
const FIXTURE_DIR = 'tests-mjs/fixtures';
...
export const unitRunnerCases = [
  {
    ...
    fn: async () => {
      ...
      assertTrue(
        run.stderr.includes("WATCHDOG: 'tests-mjs' silent for"),
...

  {
    ...
    fn: async () => {
      ...
      assertTrue(
        ...
        `the failure must be attributed to A: ${run.stdout.slice(-400)}`,
      );
    },
  },
