...
import { deriveRequests, loadForest, runForest } from './gate-forest-lib.mjs';
...
const PRESENCE_TABLE = [
  {
    item: '无死边',
    symbols: [['testkit/opencode/scenario-schema.js', 'deadEdges']],
    cases: [
      ['testkit/opencode/tests/gate-schema-cases.mjs', 'VERIFY-003 a turn no flow can reach is rejected'],
    ],
  },
  {
    item: '索引无冲突',
    symbols: [
      ['testkit/opencode/scenario-schema.js', 'duplicateDeclarations'],
      ['testkit/opencode/runtime-key.js', 'ambiguousTurn'],
    ],
    cases: [
      [
        'testkit/opencode/tests/gate-schema-cases.mjs',
      ...
      [
        'testkit/opencode/tests/gate-runtime-key-cases.mjs',
  ...
  },
  {
    item: 'fault 有限',
    symbols: [
      ['testkit/opencode/delivery-plan.js', 'validateFault'],
      ['testkit/opencode/scenario-schema.js', 'conflictingFaults'],
    ],
    cases: [
      [
        'testkit/opencode/tests/gate-delivery-cases.mjs',
