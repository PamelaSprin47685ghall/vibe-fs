...
async function runTests() {
  ...
  function findJsFiles(dir) {
    ...
    for (const file of list) {
      ...
      } else if (file.endsWith(".js") && !file.endsWith("TestSupport.js") && !file.endsWith("GateSupport.js") && !file.endsWith("Support.js") && !file.endsWith("Signatures.js") && !file.endsWith("Assert.js") && !file.endsWith("EventDrivenHarness.js") && !file.includes(".nuget")) {
