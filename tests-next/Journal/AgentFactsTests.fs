...
module AgentFactsTests =
    ...
    let Double_perfect_same_tree_fold () =
        ...
        let proj = Fold.applyAgentFacts AgentProjection.empty [ env1; envC; env2 ]
    ...
    let Revise_and_hash_change_resets_perfects () =
        ...
        let proj = Fold.applyAgentFacts AgentProjection.empty [ env1; env2; env3 ]
    ...
    let ``Fallback_modulo4_cursor_advances_without_death`` () =
        ...
        let proj1 = Fold.applyAgentFacts AgentProjection.empty [ env1 ]
        ...
        let proj2 = Fold.applyAgentFacts AgentProjection.empty [ env1; env2 ]
        ...
        let proj3 = Fold.applyAgentFacts AgentProjection.empty [ env1; env2; env3 ]
        ...
        let proj4 = Fold.applyAgentFacts AgentProjection.empty [ env1; env2; env3; env4 ]
        ...
        let proj5 = Fold.applyAgentFacts AgentProjection.empty [ env1; env2; env3; env4; env5 ]
