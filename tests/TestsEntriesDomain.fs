...
let domainTestEntries () : (string * TestBody) list =
    ...
    "DomainTests.formatDomainErrorTaskWaitBackgrounded", TestBody.Sync (sync DomainTests.formatDomainErrorTaskWaitBackgrounded)
    "DomainTests.formatDomainErrorExecutorExecutableMissing", TestBody.Sync (sync DomainTests.formatDomainErrorExecutorExecutableMissing)
    ...
    "DomainTests.formatDomainErrorNetworkTransportFailure", TestBody.Sync (sync DomainTests.formatDomainErrorNetworkTransportFailure)
    "DomainTests.formatDomainErrorNetworkTransportFailureNone", TestBody.Sync (sync DomainTests.formatDomainErrorNetworkTransportFailureNone)
    "DomainTests.formatDomainErrorClientCancellation", TestBody.Sync (sync DomainTests.formatDomainErrorClientCancellation)
    "DomainTests.formatDomainErrorHostProtocolMismatch", TestBody.Sync (sync DomainTests.formatDomainErrorHostProtocolMismatch)
    ...
    "DomainTests.isAbortFalseForNetworkTransportFailure", TestBody.Sync (sync DomainTests.isAbortFalseForNetworkTransportFailure)
    "DomainTests.isAbortFalseForHostProtocolMismatch", TestBody.Sync (sync DomainTests.isAbortFalseForHostProtocolMismatch)
    ...
    "DomainTests.classifyErrorLeafAbortSignalByName", TestBody.Sync (sync DomainTests.classifyErrorLeafAbortSignalByName)
    "DomainTests.classifyErrorLeafAbortByTag", TestBody.Sync (sync DomainTests.classifyErrorLeafAbortByTag)
    "DomainTests.classifyErrorLeafSessionBusyByName", TestBody.Sync (sync DomainTests.classifyErrorLeafSessionBusyByName)
    "DomainTests.classifyErrorLeafSessionBusyByTag", TestBody.Sync (sync DomainTests.classifyErrorLeafSessionBusyByTag)
    "DomainTests.classifyErrorLeafBackgroundedByName", TestBody.Sync (sync DomainTests.classifyErrorLeafBackgroundedByName)
    "DomainTests.classifyErrorLeafBackgroundedByTag", TestBody.Sync (sync DomainTests.classifyErrorLeafBackgroundedByTag)
    "DomainTests.classifyErrorLeafFallbackAbortText", TestBody.Sync (sync DomainTests.classifyErrorLeafFallbackAbortText)
    "DomainTests.classifyErrorLeafHostProtocolMismatchByTag", TestBody.Sync (sync DomainTests.classifyErrorLeafHostProtocolMismatchByTag)
