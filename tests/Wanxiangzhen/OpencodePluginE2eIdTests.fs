module Wanxiangshu.Tests.Wanxiangzhen.OpencodePluginE2eIdTests
...
let testSquadUpdateGeneratesUniqueIds () : JS.Promise<unit> =
    promise {
        ...
        let cmdInput =
            createObj
                [ "command", box "squad"
                  "sessionID", box "sess-unique"
                  "arguments", box "unique-id-test" ]
        ...
        let evts =
            createObj [ "events", box [| mkTasksCreated [ mkT "T1" "D1"; mkT "T2" "D2" ] |] ]
...
let testSquadUpdateRetriesGeneratedIdOnRefCollision () : JS.Promise<unit> =
    promise {
        ...
        let cmdInput =
            createObj
                [ "command", box "squad"
                  "sessionID", box "sess-collision"
                  "arguments", box "collision-test" ]
        ...
        let evtObj =
            mkTasksCreated [ mkTask "" "Collision-Test" "Verify fallback after 10 ref-collision retries" [] ]
