module Wanxiangshu.Tests.Wanxiangzhen.OpencodePluginE2eCancelKillTests
...
let testSquadUpdateCancelsRunningTask () : JS.Promise<unit> =
    promise {
        ...
        let cmdInput =
            createObj
                [ "command", box "squad"
                  "sessionID", box "sess-cancel"
                  "arguments", box "cancel-test" ]
        ...
        let cancelEvt = createObj [ "type", box "squad_cancelled" ]
