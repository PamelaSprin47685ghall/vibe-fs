...
let architectureTestEntriesPartA () : (string * TestBody) list =
    ...
    "ArchitectureTests.returnReviewerCatalogAndHostRegistration", Sync (sync ArchitectureTestsFoundation.returnReviewerCatalogAndHostRegistration)
    ...
    "ArchitectureTests.nudgeDedupMustUseEventLogFold", Sync (sync ArchitectureTestsFoundation.nudgeDedupMustUseEventLogFold)
    "ArchitectureTests.nudgeLoopStateMustReplayHistory", Sync (sync ArchitectureTestsFoundation.nudgeLoopStateMustReplayHistory)
    ...
    "ArchitectureTests.ompMessagingCodecUsesShellPartCodec", Sync (sync ArchitectureTestsOmp.ompMessagingCodecUsesShellPartCodec)
    "ArchitectureTests.ompCodecUsesDynModule", Sync (sync ArchitectureTestsOmp.ompCodecUsesDynModule)
    "ArchitectureTests.ompHookExecuteUsesSubagentIntentsCodec", Sync (sync ArchitectureTestsOmp.ompHookExecuteUsesSubagentIntentsCodec)
    ...
    "ArchitectureTests.ompNudgeHooksDoNotReadReviewStoreForLoopState", Sync (sync ArchitectureTestsOmp.ompNudgeHooksDoNotReadReviewStoreForLoopState)
    ...
    "ArchitectureTests.muxMessageTransformUsesReadDedupMuxPlugin", Sync (sync ArchitectureTestsMessageTransformCaps.muxMessageTransformUsesReadDedupMuxPlugin)
    "ArchitectureTests.muxMessageTransformUsesMuxHookInputCodec", Sync (sync ArchitectureTestsMessageTransformCaps.muxMessageTransformUsesMuxHookInputCodec)
    "ArchitectureTests.muxWrappersCaptureUsesProjectionNotModuleCapture", Sync (sync ArchitectureTestsMessageTransformCaps.muxWrappersCaptureUsesProjectionNotModuleCapture)
    "ArchitectureTests.opencodeMessageTransformNoLocalCapsBuilder", Sync (sync ArchitectureTestsMessageTransformCaps.opencodeMessageTransformNoLocalCapsBuilder)
    "ArchitectureTests.opencodeMessageTransformUsesShellCapsCache", Sync (sync ArchitectureTestsMessageTransformCaps.opencodeMessageTransformUsesShellCapsCache)
    "ArchitectureTests.noReconstructReviewStateInMessageTransforms", Sync (sync ArchitectureTestsMessageTransformCaps.noReconstructReviewStateInMessageTransforms)
    "ArchitectureTests.messageTransformUsesHostEntry", Sync (sync ArchitectureTestsMessageTransformCaps.messageTransformUsesHostEntry)
    "ArchitectureTests.capsFileCacheCompositeKey", Sync (sync ArchitectureTestsMessageTransformCaps.capsFileCacheCompositeKey)
    "ArchitectureTests.capsFileCacheNoGetOrLoadCapsFilesDefault", Sync (sync ArchitectureTestsMessageTransformCaps.capsFileCacheNoGetOrLoadCapsFilesDefault)
    "ArchitectureTests.capsFileCacheUsesInflight", Sync (sync ArchitectureTestsMessageTransformCaps.capsFileCacheUsesInflight)
    ...
    "ArchitectureTests.opencodeSubagentToolsUsesFromOpencode", Sync (sync ArchitectureTestsSubagentSession.opencodeSubagentToolsUsesFromOpencode)
    ...
    "ArchitectureTests.sessionIoUsesOpencodeClientCodec", Sync (sync ArchitectureTestsRuntimeSession.sessionIoUsesOpencodeClientCodec)
    "ArchitectureTests.sessionIoUsesSubagentResultPath", Sync (sync ArchitectureTestsRuntimeSession.sessionIoUsesSubagentResultPath)
    "ArchitectureTests.opencodeNoDirectClientSessionDyn", Sync (sync ArchitectureTestsRuntimeSession.opencodeNoDirectClientSessionDyn)
