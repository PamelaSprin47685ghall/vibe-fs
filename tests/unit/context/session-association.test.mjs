// tests/unit/Context/session-association.test.mjs — HOST-008 / COMPANION-001/002/003.
//
...
import { sessionAssociation as assoc } from '../support/domain.mjs'
...
// ── PERSIST-008: both directions are keyed lookups ─────────────────────────
