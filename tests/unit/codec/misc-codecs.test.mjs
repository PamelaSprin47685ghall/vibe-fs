// MISC codec cluster: OpencodeTypes records, CanonicalJson, HostMessageCodec
// decode branches, PromptIngressCodec decode. Pure encode/decode + malformed
// input — no ports, no journal.

import assert from 'node:assert/strict'
import test from 'node:test'

import { caseOf, payloadOf } from '../support/domain.mjs'
