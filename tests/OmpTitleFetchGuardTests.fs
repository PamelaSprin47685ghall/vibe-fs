module VibeFs.Tests.OmpTitleFetchGuardTests
...
let detectProbeUserContent () =
    ...
    let systemOnly = box "{\"messages\":[{\"role\":\"system\",\"content\":\"Generate a title for this conversation\"}]}"
...
let rewriteStringContent () =
    ...
    let userMsg = createObj [ "role", box "user"; "content", box "important context to wrap" ]
