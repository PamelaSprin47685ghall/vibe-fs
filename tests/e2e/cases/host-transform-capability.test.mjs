 ...
 *    (reviewer-verdict scenario) and X SolvingProviderRun (context-recovery scenario);
...
try {
  ...
  const source = fs.readFileSync(new URL('../scenarios/host-transform-capability.toml', import.meta.url), 'utf8');
