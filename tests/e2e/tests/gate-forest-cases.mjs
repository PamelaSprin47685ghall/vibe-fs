...
const PRESENCE_TABLE = [
  {
    item: '无死边',
    symbols: [['tests/e2e/scenario-schema.js', 'deadEdges']],
    cases: [
      ['tests/e2e/tests/gate-schema-cases.mjs', 'VERIFY-003 a turn no flow can reach is rejected'],
    ],
  },
  {
    item: '索引无冲突',
    symbols: [
      ['tests/e2e/scenario-schema.js', 'duplicateDeclarations'],
      ['tests/e2e/runtime-key.js', 'ambiguousTurn'],
    ],
    cases: [
      [
        'tests/e2e/tests/gate-schema-cases.mjs',
      ...
      [
        'tests/e2e/tests/gate-runtime-key-cases.mjs',
  ...
  },
  {
    item: 'fault 有限',
    symbols: [
      ['tests/e2e/delivery-plan.js', 'validateFault'],
      ['tests/e2e/scenario-schema.js', 'conflictingFaults'],
    ],
    cases: [
      [
        'tests/e2e/tests/gate-delivery-cases.mjs',
