/**
 * index.js — Public re-exports for tests/e2e harness.
 */
...
export { Scenario, setupScenario, teardownScenario, FsOracle, HttpClient, getSessionId } from './scenario.js';
export { gatherDiagnostics, formatDiagnostics, dumpDiagnostics } from './diagnostics.js';
export { runStaticGate } from './stability-checker.js';
