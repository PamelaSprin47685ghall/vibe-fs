...
let muxExecutorRoCatPrependsWarningSpec () = promise {
    ...
    if isNullish executor then
        ...
        let args = createObj [ "language", box "shell"; "program", box "cat /etc/passwd"; "timeout_type", box "short"; "mode", box "ro"; "what_to_summarize", box "summarize exit codes"; "warn", box "it-is-not-possible-to-do-it-using-other-tools" ]
