...
let spec_tryGetMaxInputTokensAsync_realSchema () =
    promise {
        ...
        let client = createObj [
            "session",
            createObj [ "get",
                box (System.Func<obj, JS.Promise<obj>>(mockSessionGet)) ]
            "provider",
            createObj [ "list",
                box (System.Func<obj, JS.Promise<obj>>(mockProviderList)) ]
        ]

        let! limit = tryGetMaxInputTokensAsync client "s-async"
        equal "limit.input from provider.list"
            (Some 200000) limit
        check "session.get flat sessionID arg" (
    ...
    promise {
        let mockGet (_arg: obj) =
            promise {
                return createObj [
                    "data", createObj [
                        "model", createObj [ "id", box "gpt-4"; "providerID", box "openai" ]
                    ]
                ]
            }
                        ...
                        "all", box [|
                            createObj [
                                ...
                                "models", createObj [
                                    "gpt-4", createObj [
                                        "limit", createObj [
                                            "context", box 128000; "output", box 4096
                                        ]
                                    ]
                                ]
                            ]
        ...
        let client = createObj [
            "session", createObj [ "get",
                box (System.Func<obj, JS.Promise<obj>>(mockGet)) ]
            "provider", createObj [ "list",
                box (System.Func<obj, JS.Promise<obj>>(mockList)) ]
        ]
...
let spec_tryGetRealContextUsage_realSchema () =
    promise {
        ...
        check "flat sessionID arg" (
            not (isNullish capturedArg) &&
            string (get capturedArg "sessionID") = "s-real"
        )
    }
...
let spec_tryGetRealContextUsage_noTokens () =
    promise {
        let mockGet (_arg: obj) =
            promise {
                return createObj [ "data", createObj [ "title", box "no tokens" ] ]
            }
        let client = createObj [
            "session", createObj [
                "get", box (System.Func<obj, JS.Promise<obj>>(mockGet))
    ...
    promise {
        ...
        let t = createObj [
            "session", createObj [
                "model", createObj [
                    "limit", createObj [
                        "context", box 60000; "output", box 4000
                    ]
                ]
            ]
        ]
