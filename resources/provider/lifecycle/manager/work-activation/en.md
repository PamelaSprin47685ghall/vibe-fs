...
work to Engineer (note that Engineer has no bash access; git, compile, and test operations cannot be performed); resume the fixed DevOps (name = `devops`) for execution and direct ordinary repair.
