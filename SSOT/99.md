...
| LifecycleWorkRecord | COMPANION-003：Opening + Y frames + X gap + Terminal 的唯一跨 Session 工作记录 |
...
| 术语 | 指向 |
|------|------|
| RawGap | COMPANION-003：Y 尚未覆盖的 X suffix，只用于 LWR 补洞 |
...
| TerminalOutputRaw | COMPANION-003：Session 末次输出原文，作为 LWR 末段 |
