...
本文件记录 property-testing 的工具选择证据，不定义产品语义。语义仅来自对应 `requirements/<package>/WHAT.md`。初次复核基线为 `ff85615e9a8dc0c94447eb55960a72deb46ed9db`；提交前已重放到 `upstream/master@1d4d810c7`。
