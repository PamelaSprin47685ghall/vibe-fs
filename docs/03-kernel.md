...
| 其他 | `Config`、`ToolCopy`、`ToolArgs`、`ToolResult`、`ToolOutputInfo`、`ToolOutputInfoTypes`、`ToolOutputInfoParse`、`ToolExecutionStatus`、`ToolContext`、`ToolCatalogParams`、`WebFetchGuard`、`ReviewVerdict`、`WarnTdd`、`FinishReason`、`SessionGateDemand`、`SessionLoop`、`WorkBacklog` | 横切 |
