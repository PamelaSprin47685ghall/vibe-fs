...
| Pair Hint semantic payload | HOST-013 `resources/provider/host/pair-programming-guideline` | Cursor/ordinary 只换 wire renderer；User/System 实验 role 不成为 PromptIngress authority |
