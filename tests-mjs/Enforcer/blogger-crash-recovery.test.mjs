...
const recoverySrc = readFileSync(
  join(ROOT, 'src/Wanxiangshu.Next/Application/Reconciliation/BloggerCrashRecovery.fs'),
  'utf8',
)
const spikeSrc = readFileSync(
  join(ROOT, 'src/Wanxiangshu.Next/Infrastructure/OpenCode/Plugin/SpikePlugin.fs'),
  'utf8',
)
const scopeSrc = readFileSync(
  join(ROOT, 'src/Wanxiangshu.Next/Infrastructure/OpenCode/Host/PluginRuntimeScope.fs'),
  'utf8',
)
