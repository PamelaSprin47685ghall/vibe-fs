#!/usr/bin/env node
// tests-mjs/runner.mjs — layers 1-3 entry point, and the causal-progress gate over them.
//
...
//
// Discovery is *.test.mjs under tests-mjs/. No compile step, no export scanning: node:test owns
// registration.
//
...
import { Watchdog } from '../testkit/opencode/watchdog.js'
import { UNIT_VERDICT_SILENCE_MS } from '../testkit/opencode/time-budget.js'
