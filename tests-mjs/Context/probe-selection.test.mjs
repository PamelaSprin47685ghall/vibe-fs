// tests-mjs/Context/probe-selection.test.mjs — CTX-011 candidate selection.
//
...
import { prefixEpochProjection as prefix, probeSelection as selection } from '../domain.mjs'
...
test('CTX_011_no_completed_turn_yet_means_no_candidate', () => {
...
test('CTX_011_coverage_inside_the_live_tail_means_no_candidate', () => {
...
test('CTX_011_the_candidate_never_swallows_the_message_being_answered', () => {
...
test('CTX_011_a_retreating_candidate_is_refused', () => {
  const result = selection.select({
    committedEpoch: 2,
...
test('CTX_011_the_same_cutoff_with_a_tighter_B_is_a_new_candidate', () => {
...
test('COMPANION_011_the_proof_hashes_exactly_the_clamped_cutoff', () => {
...
test('COMPANION_011_the_proof_runs_even_when_the_candidate_looks_identical', () => {
...
test('CTX_012_the_probe_carries_the_seal_the_promotion_will_reuse', () => {
...
test('CTX_010_the_probe_records_the_epoch_it_was_built_from', () => {
...
test('CTX_012_the_built_candidate_is_exactly_what_the_projection_will_promote', () => {
...
test('CTX_011_a_candidate_the_selector_refuses_is_one_the_fold_would_also_refuse', () => {
