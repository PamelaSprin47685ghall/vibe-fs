// tests-mjs/Verify/degradation-list.test.mjs — VERIFY-004 「禁止退化清单」.
//
...
import {
  ...
  SSOT_ORIGIN,
  parseDegradations,
} from '../../testkit/opencode/tests/degradation-list.mjs'

/**
 * The thirteen items as they stand in SSOT/10.md today.
 *
...
test('VERIFY_004_the_forbidden_degradations_are_read_from_the_SSOT_in_order', () => {
  ...
  assert.equal(SSOT_ORIGIN, 'SSOT/10.md')
})
