// tests-mjs/Journal/boot.test.mjs — PERSIST-002/004/006, verification layer 2.
//
...
import { caseOf, envelope, fact, idValue, journal, journalStore, payloadOf, sessionId, stream } from '../domain.mjs'
