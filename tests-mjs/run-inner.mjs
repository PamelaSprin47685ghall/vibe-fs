// tests-mjs/run-inner.mjs — the inner tier: node:test itself, semantics unchanged.
//
...
import { PER_TEST_TIMEOUT_MS, SUITE_BACKSTOP_MS } from '../testkit/opencode/time-budget.js'
